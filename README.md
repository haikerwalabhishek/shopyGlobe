...
## Overview
This Shoppy Globe is a simple frontend-only web application built using Vite and React. It demonstrates basic functionality without using a database or local storage to save tasks.

## Features
- **Home**: where product data is comming from api.
- **Cart**: To add product in cart to checkout.
...
# Website Link
[link](https://haikerwalabhishek.github.io/shopyGlobe/)


<img src="https://raw.githubusercontent.com/haikerwalabhishek/shopyGlobe/refs/heads/main/preview.png">&nbsp;&nbsp;&nbsp;&nbsp;
